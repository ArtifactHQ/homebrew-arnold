class Arnold < Formula
  ...
  url "https://github.com/ArtifactHQ/Arnold-Prime.git",
      tag:      "v0.3.0",
      revision: "a78aa2be735b492101eba3d31f55379c768c72ca"
  license "MIT"
  ...
  def install
    ...
    # Copy the project into libexec. Gemfile.lock is gitignored, so we copy
    # the one generated by `bundle install` above.
    libexec.install Dir["app", "config", "db", "exe", "lib", "library",
                        "Gemfile", "arnold_pipeline.gemspec",
                        "Rakefile", "MIT-LICENSE", ".bundle"]
    cp "Gemfile.lock", libexec/"Gemfile.lock"
